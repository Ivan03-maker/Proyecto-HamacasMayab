...
export function ProductsPage({
	...
	return (
		<div className="bg-background min-h-screen">
			...
			<div className="relative bg-linear-to-br from-orange-700 via-red-700 to-orange-900 text-white py-20 overflow-hidden">
				{/* Imagen de fondo */}
				<div className="absolute inset-0">
					...
					<div className="absolute inset-0 bg-linear-to-br from-orange-950/80 via-orange-900/70 to-orange-950/85"></div>
				</div>
										...
										<div className="p-4">
											...
											<div className="flex gap-2">
												...
												<Button
													...
													className="border-orange-600 text-orange-600 hover:bg-orange-50 shrink-0 whitespace-nowrap"
												>
